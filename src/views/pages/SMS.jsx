    ...
    return (
      <>
        ...
        */}
        ...
        <div className={`blackdiv ${true? 'spinner' : 'NoSpinner'} `} id="blackdiv" 
        >
          <div className="ui segment">
            <div className={`ui active transition ${inverted} visible dimmer`}>
              <div className="content">
