...
import {
  ...
  ModalHeader,
  ModalFooter,
  ListGroup, ListGroupItem, Badge, CardFooter
} from "reactstrap";
...
class DatabasesForm extends React.Component {
  state = {
    ...
    muniRomeo: [
      ...
      {
        'label': 'San Andrés Sajcabajá',
        'value': 'San Andrés Sajcabajá'
      },
      {
      ...
      {
        'label': 'San Juan Ostuncalco',
        'value': 'San Juan Ostuncalco'
      },
      {
        'label': 'Totonicapan',
        'value': 'Totonicapan'
      ...
      {
        'label': 'San Miguel Acatán',
        'value': 'San Miguel Acatán'
      },
      {
        'label': 'Santa Catalina La Tinta',
        'value': 'Santa Catalina La Tinta'
      },
      {
        'label': 'Santa Clara La Laguna',
        'value': 'Santa Clara La Laguna'
      },
      {
        'label': 'Guatemala',
        'value': 'Guatemala'
      ...
      },
      {
        ...
        'value': 'San Antonio Suchitepequez'
      },
      {
        'label': 'Masagua',
        'value': 'Masagua'
      ...
      {
        'label': 'San Juan Comalapa',
        'value': 'San Juan Comalapa'
      },
  ...
  toggleEditModalGruop = () => {
    this.setState({
      editModalGroup: !this.state.editModalGroup
    });
  }
  ...
  render() {
    ...
    let name;
    let filteredmuns = municipios.filter(m => m.name === (departamentSelect && departamentSelect))
      ...
      <>
        ...
        <div className="content">
          ...
          <Modal
            ...
            toggle={this.toggleEditModalGruop}
          ...
          >
            ...
            <ModalFooter>
              <Button color="secondary" onClick={() => this.toggleEditModalGruop()}>
                Cerrar
              </Button>
              <Button color="primary" onClick={() => {
                createGroup(this.state.Form, this.state.dbsSelected, this.state.group)
                this.toggleEditModalGruop()
              }
              }>
                Crear Grupo
              </Button>
                                          ...
                                          <Row>
                                            <Col>
                                              <FormGroup >
                                                <Field
                                                  name={`${index.name}|${index.type}-1`}
                                                  component={index.name === 'DEPARTAMENTO_ROMEO'? this.FormSelectMunicipio : this.FormSelect}
                                                  //		validate={[this.required, this.verifyNumberProduction]}
                                                  placeholder="Departamentos"
                                                  // type='number'
                                                  options={index.name === 'DEPARTAMENTO_ROMEO'? departRomeo  : departamentos}
                                                />
                                              </FormGroup>
                                            </Col>
                                          </Row>
                                              ...
                                              <Col>
                                                <FormGroup >
                                                  <Field
                                                    ...
                                                    //   type='number'
                                                    options={index.name === 'MUNICIPIO_ROMEO'? muniRomeo : (departamentSelect ? (filteredmuns[0] && filteredmuns[0].minicipios) : municipiosTotal)}
                                                  />
                                                </FormGroup>
                                              </Col>
                                            </Row>
                      ...
                      <CardFooter>
                        <Row>
                          <Col>
                            <Button
                              style={{ width: '100%' }}
                              onClick={() => this.toggleEditModalGruop()}
                            >
                              Crear Grupo
                            </Button>
                            <Field
                              //name={`${index.name}|${index.type}-1`}
                              component={this.FormSelectGroup}
                              //		validate={[this.required, this.verifyNumberProduction]}
                              placeholder="Grupos"
                              //   type='number'
                              options={group}
                    ...
                    <Row>
                      <Col>
                        <Button
                          ...
                          disabled={loadingAction}
                          onClick={() => {
                            sendMail(this.state.selectedGroup, this.state.FilterForm.text)
                            this.setState({
                              FilterForm: {
                                ...FilterForm,
                                text: ''
...
export default connect(
  ...
  (dispatch) => ({
    ...
    getGroup() {
      dispatch(filterActions.getGroup())
    },
    getInfo() {
    ...
    createGroup(FilterForm, db, group) {
      console.log(FilterForm, 'primero')
      console.log(db, 'segundo')
      console.log(group, 'tercero')
      dispatch(filterActions.createGroup({
        FilterForm: FilterForm,
        dbs: db,
        index: '0',
        group: group
    ...
    sendMail(group1, text) {
      console.log(group1, 'grup')
      if (
         group1 === null) {
